...
const uint32_t GPIO_CLK[LEDn] = {LED1_GPIO_CLK, LED2_GPIO_CLK, LED3_GPIO_CLK};
 ...
 GPIO_TypeDef* BUTTON_PORT[BUTTONn] = {WAKEUP_BUTTON_PORT, KEY_BUTTON_PORT}; 
 const uint16_t BUTTON_PIN[BUTTONn] = {WAKEUP_BUTTON_PIN, KEY_BUTTON_PIN}; 
 const uint32_t BUTTON_CLK[BUTTONn] = {WAKEUP_BUTTON_CLK, KEY_BUTTON_CLK};
 const uint16_t BUTTON_EXTI_LINE[BUTTONn]
                    = {WAKEUP_BUTTON_EXTI_LINE, KEY_BUTTON_EXTI_LINE};
 const uint16_t BUTTON_PORT_SOURCE[BUTTONn]
                    = {WAKEUP_BUTTON_PORT_SOURCE, KEY_BUTTON_PORT_SOURCE};
 const uint16_t BUTTON_PIN_SOURCE[BUTTONn]
                    = {WAKEUP_BUTTON_PIN_SOURCE, KEY_BUTTON_PIN_SOURCE}; 
 const uint16_t BUTTON_IRQn[BUTTONn]
                    = {WAKEUP_BUTTON_IRQn, KEY_BUTTON_IRQn};
 USART_TypeDef* COM_USART[COMn] = {EVAL_COM1}; 
 GPIO_TypeDef* COM_PORT[COMn] = {EVAL_COM1_GPIO};
 const uint32_t COM_USART_CLK[COMn] = {EVAL_COM1_CLK};
 const uint32_t COM_POR_CLK[COMn] = {EVAL_COM1_GPIO_CLK};
